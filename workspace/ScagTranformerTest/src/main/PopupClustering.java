...
public class PopupClustering{
	...
	public PopupClustering(PApplet parent_){
		parent = parent_;
	}
	...
	public void draw2(){
		...
		if (b>=0){
			...
			for (int i=0;i<sNames.length;i++){
				...
				parent.textAlign(PApplet.CENTER);
				parent.text(sNames[i],x+100,y+itemH*(i+1));
			}	
		}
		else{
			parent.textFont(metaBold,18);
			parent.fill(0,0,0);
			parent.textAlign(PApplet.CENTER);
			parent.text(sNames[sS],x+w/2+5,y+22);
		}	
