...
class Triangulation {
    ...
    private double computeStriationMeasure() {
        ...
        while (it.hasNext()) {
            ...
            if (n1.mstDegree == 2 && n2.mstDegree == 2) {
                ...
                if (cosineOfAdjacentEdges(e, e1, n1) < -.75 && cosineOfAdjacentEdges(e, e2, n2) < -.75)
                    numEdges++;
            }
        }
    ...
    private void expandTri(Edge e, Node nd, int type) {
        ...
        if (type == 2)    // nd is inside of the triangle
        {
            ...
            swapTest(e1,0);   // swap test for the three new triangles
            swapTest(e2,0);
            swapTest(e3,0);
...
//								shareEdges(e03,e30);
                ...
                swapTest(e2,0);   // swap test for the two new triangles
                swapTest(e3,0);
                swapTest(e30,0);
            } else         // two triangle involved
            {
                ...
                swapTest(e2,0);   // swap test for the three new triangles
                swapTest(e3,0);
                swapTest(e5,0);
                swapTest(e6,0);
                swapTest(e10,0);
    ...
    private void swapTest(Edge e11, int times) {
    	if (times>4) return;
        Edge e21 = e11.invE;
        ...
        if (e11.inT.inCircle(e22.p2) || e21.inT.inCircle(e12.p2)) {
            ...
            e12.asIndex();
            e22.asIndex();
            swapTest(e12, times+1);
            swapTest(e22, times+1);
            swapTest(e13, times+1);
            swapTest(e23, times+1);
        }
    }
