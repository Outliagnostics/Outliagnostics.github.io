...
public class Binner {
    ...
    public final BinnedData binHexLeave1out(double[] x, double[] y,int indexLeave1out, int nBins) {
        int n = x.length;
        // scaling constants
        double con1 = .25;
        double con2 = 1. / 3.;
        ...
        for (int i = 0; i < n; i++) {
        	// Tommy 2017, skip invalid data ***********************
        	if (i== indexLeave1out || Double.isNaN(x[i]) || Double.isNaN(y[i]))
				continue;
